...
import { DialogContent, DialogHeader, DialogDescription, DialogTitle, DialogClose } from "@/components/ui/dialog"
...
export function AddToSiteProductModalContent({ id }: { id: { id: string }}) {
    ...
    return <DialogContent className="max-w-max">
    <DialogHeader>        
    ...
    <pre className="mb-4 overflow-x-auto p-4 bg-secondary rounded max-w-screen-xl 
